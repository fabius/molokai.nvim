...
local black = hsl(0, 0, 100)
local black2 = hsl(60, 36, 90)
local black3 = hsl(60, 30, 96)
local blue = hsl(190, 81, 33)
local grey = hsl(55, 8, 79)
local orange = hsl(32, 98, 44)
local orange2 = hsl(30, 83, 66)
local orange3 = hsl(47, 100, 21)
local purple = hsl(261, 100, 25)
local red = hsl(0, 93, 41)
local red2 = hsl(338, 95, 44)
local white = hsl(0, 0, 0)
local white2 = hsl(60, 17, 11)
local white3 = hsl(70, 8, 15)
local yellow = hsl(54, 70, 32)
local yellow2 = hsl(80, 76, 37)
local yellow3 = hsl(60, 12, 21)
local yellow4 = hsl(55, 11, 88)
local yellow5 = hsl(50, 11, 59)
...
local theme = lush(function(injected_functions)
    ...
    return {
        ...
        DiffAdd { bg = yellow2.mix(Normal.bg, 90), fg = yellow2.da(10), }, -- Diff mode: Added line |diff.txt|
        DiffChange { bg = blue.mix(Normal.bg, 90), fg = blue.da(10), },    -- Diff mode: Changed line |diff.txt|
        DiffDelete { bg = red.mix(Normal.bg, 90), fg = red.da(10), },      -- Diff mode: Deleted line |diff.txt|
        ...
        --
        DiagnosticError { fg = red.da(10), bg = red.mix(Normal.bg, 90) },      -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticWarn { fg = orange.da(10), bg = orange.mix(Normal.bg, 90) }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticInfo { fg = blue.da(10), bg = blue.mix(Normal.bg, 90) },     -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticHint { fg = blue.da(10), bg = blue.mix(Normal.bg, 90) },     -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
        DiagnosticOk { fg = yellow2.da(10), bg = yellow2.mix(Normal.bg, 90) }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
